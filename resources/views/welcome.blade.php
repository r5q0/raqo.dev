...
<body class="bg-[#272424] ">
    ...
    <div class="bg-white text-center p-5 rounded-lg m-2 md:m-10">
            <h2 class="font-black">📝 Blog</h2>
            <p>Step into my world! 🌐 Explore a variety of blogs ranging from development insights to topics that capture my attention. Discover what keeps me inspired and busy. 📚</p>
        </div>

        <div class="bg-white text-center p-5 rounded-lg m-2 md:m-10">
            <h2 class="font-black">🛠️ Projects</h2>
            <p>Discover my portfolio of both open and closed-source projects. 🚀 Stay tuned for corresponding blogs that delve into the development journey behind each project. 📰</p>
        </div>

        <div class="bg-white text-center p-5 rounded-lg m-2 md:m-10">
            <h2 class="font-black">🚀 Services</h2>
            <p>Explore a galaxy of possibilities! 🌌 Here, you'll discover the stellar services I offer, including web development, servers, VPS solutions, and more. 🛠️</p>
        </div>
